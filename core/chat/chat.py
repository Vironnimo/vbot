...
class ChatLoop:
    ...
    async def _create_run_execution_context(
        ...
        *,
        ...
        working_project_context = await _CHAT_TRANSFORM_WORKERS.run(
            self.pinned_working_project_context,
            run.agent_id,
            run.session_id,
            prompt_project,
            project_prompt_context,
    ...
    def pinned_working_project_context(
        ...
        self.stamp_prompt_files_read(session_id, read_paths)
        return text
