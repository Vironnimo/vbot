...
def _record(media_type: str) -> AttachmentRecord:
...
def test_text_stays_a_file_reference_for_the_shared_read_renderer() -> None:
    blocks = content_blocks_for_attachment(_record("text/plain"))
