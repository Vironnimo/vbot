...
**Not:** A Project Agent or Rooted Agent. A Visit reaches a Project other than the Identity Agent's explicitly selected Project and injects that reached Project's files/skills once.
