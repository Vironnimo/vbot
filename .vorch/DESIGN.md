...
Chat supports up to two retained areas, each switching between Chat and Preview through the shared compact segmented TabList. A 43px area toolbar shows the current Session title or website context, with Split view when one area is visible and Close area when both are visible. The focused area receives a thin accent top rule. Closing or switching content preserves the area's Chat draft and scroll position.
