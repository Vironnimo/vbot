...
- Project removal is an archive operation guarded by active/queued Project-Agent Run activity, Cron references, and Identity Agents rooted in the Project. Keep the coordinated checks and rollback behavior at the RPC/service boundary; a raw store delete is not the complete removal workflow.
