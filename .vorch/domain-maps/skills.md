...
- `core.skills` exports the registry/policy/authoring surfaces (`SkillRegistry`, `SkillPolicyService`, `SkillAuthoringService`), the origin vocabulary, scan helpers, and dataclasses - signatures live in code.
