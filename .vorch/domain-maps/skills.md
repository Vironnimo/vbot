...
- Both Skill Tools repair padded names, matching enclosing package-path quotes, and backslash separators before validation; repaired targets retain the same package containment and write-scope checks.
