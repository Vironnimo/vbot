...
<tr><td><b>Desktop voice</b></td><td>The optional Desktop app includes local wakeword detection, microphone selection, per-server Agent routing, Home Assistant's Okay Nabu model, and built-in or imported openWakeWord models.</td></tr>
