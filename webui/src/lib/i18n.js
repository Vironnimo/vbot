...
export const englishCatalog = Object.freeze({
  ...
  'components.description':
    'All defined UI primitives. Click, hover, and interact with each element.',
  'components.sections.buttons': 'Buttons',
  'components.sections.toasts': 'Toasts',
  'components.sections.codeBlock': 'Code block',
  'components.sections.emptyState': 'Empty state',
  'components.sections.inlineConfirm': 'Inline confirm',
  'components.sections.inputs': 'Inputs',
  'components.sections.dropdowns': 'Dropdowns',
  'components.sections.toggles': 'Toggles',
  'components.sections.tooltips': 'Tooltips (hover each icon)',
  'components.sections.typography': 'Typography',
  'components.sections.statusChips': 'Status chips',
  'components.sections.chatMessages': 'Chat — messages',
  'components.buttons.allOn': 'all on',
  'components.buttons.allOff': 'all off',
  'components.tooltips.attachFile': 'Attach file',
  'components.tooltips.copy': 'Copy to clipboard',
  'components.tooltips.delete': 'Delete message',
  'components.tooltips.regenerate': 'Regenerate response',
  'components.toast.success': 'Success',
  'components.toast.error': 'Error',
  'components.toast.warning': 'Warning',
  'components.toast.info': 'Info',
  ...
  'components.toast.infoMessage': 'Picked up from checkpoint #7.',
  'components.inlineConfirm.question': 'Archive this agent?',
  'components.inlineConfirm.archiveAgent': 'Archive agent',
  'components.inputs.settings': 'Settings input…',
  'components.inputs.apiKey': 'Password / API key…',
  'components.inputs.modal': 'Modal input (larger)…',
  'components.dropdowns.simple': 'Simple',
  'components.dropdowns.searchable': 'Searchable',
  'components.dropdowns.filter': 'Filter…',
  'components.dropdowns.noMatches': 'No matches',
  'components.dropdowns.optionA': 'Option A',
  ...
  'components.toggles.largeOff': 'Large toggle off',
  'components.toggles.smallOn': 'Small toggle on',
  'components.toggles.smallOff': 'Small toggle off',
  'components.typography.uiText': 'IBM Plex Sans — UI text',
  'components.typography.agentHeading': 'Agent heading — 22px / 600',
  'components.typography.settingsPanel': 'Settings panel — 20px / 600',
  'components.typography.modalTitle': 'Modal title — 15px / 600',
  'components.typography.messageBody': 'Message body — 14px / 400',
  'components.typography.bodyDefault': 'Body default — 13.5px / 400',
  'components.typography.navItem': 'Nav item — 13px / 500',
  'components.typography.descriptionText': 'Description text — 12.5px / 400',
  'components.typography.technicalText': 'IBM Plex Mono — technical / code',
  'components.typography.modelName': 'Model name — 13px / 400',
  'components.typography.settingsInputValue':
    'Settings input value — 12.5px / 400',
  'components.typography.toolNameArgs': 'Tool fn name & args — 12px / 500',
  'components.typography.toastChipText': 'Toast & chip text — 11.5px',
