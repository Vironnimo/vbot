...
export const englishCatalog = Object.freeze({
  ...
  'chat.activity.title': 'Activity',
  'chat.activity.eyebrow': 'Session context',
  ...
  'chat.activity.backgroundTasks': 'Background tasks',
  'chat.activity.emptyTitle': 'No background tasks',
  'chat.activity.emptyDescription':
    'Background work started from this Session will stay visible here.',
  'chat.activity.noDescription': 'No task description',
  'chat.activity.viewSession': 'View session',
  'chat.activity.currentTool': 'Current: {tool}',
  'chat.activity.status.running': 'Running',
