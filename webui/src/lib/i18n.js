...
export const englishCatalog = Object.freeze({
  ...
  'cron.detail.createTitle': 'Create cron job',
  'cron.detail.editTitle': 'Edit cron job',
  ...
  'statistics.overview.messagesByRole': 'Messages by role',
  ...
  'statistics.col.usageRate': 'Usage rate',
  ...
  'statistics.usage.measuredTurns': 'Measured turns',
  'statistics.usage.estimatedTurns': 'Estimated turns',
  ...
  'statistics.runs.avgToolsPerRun': 'Avg tools / run',
  ...
  'statistics.tools.noArgsNote': 'Tool arguments are never collected.',
  ...
  'statistics.skills.used': 'Used',
  'statistics.skills.neverUsed': 'Never used',
  ...
  'statistics.skills.neverUsedBadge': 'Never activated',
