export default Object.freeze({
  ...
  'chat.historyEmpty': 'Send the first message to this agent.',
  ...
  'chat.contextBelowOnePercent': '<1%',
  'chat.contextCard.providerInput': 'Provider input',
  'chat.contextCard.providerOutput': 'Provider output',
  'chat.contextCard.requestChanges': 'Estimated request changes',
  'chat.contextCard.input': 'Input',
  'chat.contextCard.output': 'Output',
  'chat.contextCard.cacheRead': 'Read from cache',
  'chat.contextCard.cacheWrite': 'Written to cache',
  'chat.contextCard.uncached': 'Uncached',
  'chat.contextCard.reasoning': 'Reasoning',
  'chat.contextCard.reasoningTurns': 'Reasoning ({turns} turns)',
  'chat.contextCard.avgCacheRead': 'Avg cache read per turn',
  ...
  'chat.reasoning.sections': '{count} sections',
  'chat.reasoning.copySummary': 'Copy reasoning summary',
  'chat.reasoning.summaryCopied': 'Summary copied',
  ...
  'chat.agentActivity.unreadCount': '{name}: {count} unread results',
  'chat.agentActivity.runningUnreadOne': '{name}: Running, 1 unread result',
