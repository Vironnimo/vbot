...
_PROFILE_INPUT = {
    ...
    "description": (
        ...
        "trigger: {type: context_ratio, threshold in (0, 1], optional tokens} or "
        "{type: input_tokens, tokens}, strategy: {type: summary_tail, tail_tokens, "
        "summary_model (null uses the participant's Model)} or {type: continuation}}. "
