...
The canonical Session store is `<data-dir>/sessions.db`, authorized by `<data-dir>/session-store.json`. Use this area only for diagnostics and current-format maintenance.
